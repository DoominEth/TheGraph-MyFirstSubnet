...
export class CVX extends ethereum.SmartContract {
  static bind(address: Address): CVX {
    return new CVX("CVX", address);
  }
  ...
  try_reductionPerCliff(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "reductionPerCliff",
      "reductionPerCliff():(uint256)",
      []
  ...
  totalCliffs(): BigInt {
    let result = super.call("totalCliffs", "totalCliffs():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalCliffs(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("totalCliffs", "totalCliffs():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  vecrvProxy(): Address {
    let result = super.call("vecrvProxy", "vecrvProxy():(address)", []);

    return result[0].toAddress();
  }

  try_vecrvProxy(): ethereum.CallResult<Address> {
    let result = super.tryCall("vecrvProxy", "vecrvProxy():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
